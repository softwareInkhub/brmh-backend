...
export async function handleLambdaCodegen({ message, selectedSchema, functionName, runtime, handler, memory, timeout, environment, res = null }) {
...
IMPORTANT: Output ONLY the JavaScript/Node.js code. Do NOT include any explanations, comments, markdown formatting, or natural language text. Start directly with the code.`;

  try {
    if (res) {
      // Streaming mode
      console.log('[LLM Agent] Starting streaming Lambda generation...');
      res.writeHead(200, {
